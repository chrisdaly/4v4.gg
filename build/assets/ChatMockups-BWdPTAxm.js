import{j as e,E as a}from"./index-HyVcIyen.js";const h=a.div`
...
`,ae=a.div`
  ...
  margin: 14px;
  z-index: 1;
`;function g({children:r,bg:i}){return e.jsxs(re,{$bg:i,children:[e.jsx(l,{src:"/frames/wood/WoodCorner-TL.png",$pos:"tl"}),e.jsx(l,{src:"/frames/wood/WoodCorner-TR.png",$pos:"tr"}),e.jsx(l,{src:"/frames/wood/WoodCorner-BL.png",$pos:"bl"}),e.jsx(l,{src:"/frames/wood/WoodCorner-BR.png",$pos:"br"}),e.jsx(p,{$top:!0}),e.jsx(p,{}),e.jsx(f,{$left:!0}),e.jsx(f,{}),e.jsx(ae,{children:r})]})}const x=a.div`
  flex: 1;
  display: flex;
  flex-direction: column;
  overflow: hidden;
