...
const PageOuter = styled.div`
  min-height: ${props => props.$fullHeight ? 'calc(100vh - var(--nav-height))' : '100vh'};
  padding: calc(var(--space-12) + var(--space-4)) var(--space-8) calc(var(--space-12) * 2);
  ...
  @media (max-width: 600px) {
    padding: var(--space-8) var(--space-4) calc(var(--space-12) + var(--space-4));
  }
`;
